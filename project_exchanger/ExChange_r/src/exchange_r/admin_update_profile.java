...
public class admin_update_profile extends javax.swing.JFrame {
    ...
    public void data_load() {
        update_name.setText(admin_profile_page.name1);
        update_phone.setText(admin_profile_page.phone);
        up_pass.setText(admin_profile_page.pass);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        v3 = up_pass.getText();
        try {
            String sql = "UPDATE `admin` SET Name='" + v1 + "' ,phone='" + v2 + "',pass='" + v3 + "' WHERE email ='" + Login_Form_1.admin_email + "'";
