...
public class admin_home_page extends javax.swing.JInternalFrame {
    ...
    public admin_home_page() {
        ...
        try {
            ...
            rs = pst.executeQuery();
            while (rs.next()) {
                String company_name, modeal_number, price, details,user_email;
                company_name = rs.getString("Compnay_Name");
                modeal_number = rs.getString("Model_Number");
                price = rs.getString("Price");
                details = rs.getString("Details");
                user_email = rs.getString("user_email");
                String tab_data[] = {company_name, modeal_number, price, details,user_email};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Company Name", "Model Name", "Price", "Details", "Email"
            }
        ));
